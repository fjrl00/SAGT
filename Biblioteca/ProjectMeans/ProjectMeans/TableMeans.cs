...
namespace ProjectMeans
{
     ...
     *      filas). El número de columnas es igual al número de facetas más 3.
     *      
     *      Para representar los datos se usará un array bidimensional o matriz de tipo double.
     */
    public class TableMeans : InterfaceTableMeans
    {
        /*=================================================================================
         * Constantes
         *=================================================================================*/
        ...
        public TableMeans(ListFacets lF, string design, MultiFacetsObs mfo, bool zero)
        {
            ...
            int cols = lF.Count() + 3; // nº de columnas de la matriz de observaciones
            ...
            List<double?> listMeans, List<double?> listVariances, List<double?> listStd_dev)
        {
            ...
            for (int j = 0; j < n; j++)
            {
                meansMatrix[j][cols - 3] = listMeans[j];
                meansMatrix[j][cols - 2] = listVariances[j];
                meansMatrix[j][cols - 1] = listStd_dev[j];
        ...
        private void CalculateMeans(MultiFacetsObs mfo, bool zero)
        {
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                // asignamos la desviación típica
        ...
        public void Calc_GrandMean_Variance_StdDev(MultiFacetsObs mfo, bool zero)
        {
            ...
            // int c = (this.MeansTableColumns()-3);
            for (int i = 0; i < r; i++)
            {
        ...
        public double? Data(int row, int col)
        {
            ...
            {
                throw new TableMeansException("Indice fuera de rango, posición no encontrada");
            }
        ...
        public double? VarianceData(int row)
        {
            ...
            // variable de retorno
            double? res = this.meansMatrix[row][this.MeansTableColumns() - 2];
        ...
        public double? Std_dev_Data(int row)
        {
            ...
            // variable de retorno
            double? res = this.meansMatrix[row][this.MeansTableColumns() - 1];
        ...
        public void MeanData(double? data, int row)
        {
            ...
            this.meansMatrix[row][cols - 3] = data;
        }
        ...
        public void VarianceData(double? data, int row)
        {
            ...
            int cols = this.MeansTableColumns();
            this.meansMatrix[row][cols - 2] = data;
        }
        ...
        public void Std_dev_Data(double? data, int row)
        {
            ...
            int cols = this.MeansTableColumns();
            this.meansMatrix[row][cols - 1] = data;
        }
